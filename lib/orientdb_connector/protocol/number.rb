  ...
  module Protocol
    class Number
      ...
      def type_code
        if is_of_float_type?
          "f"
        elsif is_of_double_type?
          "d"
        elsif is_of_big_decimal_type?
          "c"
        elsif is_of_byte_type?
          "b"
        elsif is_of_short_type?
          "s"
        elsif is_of_int_type?
          ""
        elsif is_of_long_type?
          "l"
        end
      end
      ...
      def is_of_float_type?
        is_of_positive_float_type? || is_of_negative_float_type?
      end

      def is_of_positive_float_type?
        has_float_value? && 1.40129846432481707e-45 <= value && value <= 3.40282346638528860e+38
      end

      def is_of_negative_float_type?
        has_float_value? && -1.40129846432481707e-45 >= value && value >= -3.40282346638528860e+38
      end

      def is_of_double_type?
        is_of_positive_double_type? || is_of_negative_double_type?
      end

      def is_of_positive_double_type?
        has_float_value? && 4.94065645841246544e-324 <= value && value <= 1.79769313486231570e+308
      end

      def is_of_negative_double_type?
        has_float_value? && -4.94065645841246544e-324 >= value && value >= -1.79769313486231570e+308
      end

      def is_of_big_decimal_type?
